  ...
  <div class="row">
    @foreach ($concedii as $value)
      ...
      <div class="col-12">
        ...
        <a class="float-right btn btn-success" href="/acceptare-concediu/{{$value->id}}">Acceptare concediu</a>
        <button class="float-right btn btn-danger"  data-toggle="modal" data-target="#respinge-modal">Respingere concediu</button>
      </div>
      </div>
